...
async function callOpenAIChatCompletions(apiKey, userMessage) {
    try {
...
async function callOpenAIListModels(apiKey) {
    try {
        const openai = new OpenAI({ apiKey });
 ...
 */
export async function handleOpenAIChoice(operation, options) {
