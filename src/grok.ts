...
async function callGrokChat(apiKey: string, modelName: string, systemMessage: string, userMessage: string) {
  try {
 ...
 */
export async function handleGrokChoice(operation: string, options: { model?: string, inputText?: string }) {
